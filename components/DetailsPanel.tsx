      ...
      <div className={`flex-1 overflow-hidden relative transition-opacity duration-200 ${isCollapsed ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
        ...
        <div className="absolute inset-0 z-50 bg-black/10 backdrop-blur-[1px] flex items-center justify-center p-4 animate-in fade-in duration-200">
          ...
          <div className="flex border-b border-stone-200 bg-stone-50/50 shrink-0">
             <button onClick={() => setActiveTab('details')} className={`flex-1 py-2.5 text-[10px] font-bold uppercase tracking-wider transition-colors ${activeTab === 'details' ? 'text-church-700 border-b-2 border-church-500 bg-church-50/30' : 'text-stone-400 border-b-2 border-transparent hover:text-stone-600 hover:bg-stone-100/50'}`}>Liturgy Details</button>
             <button onClick={() => setActiveTab('settings')} className={`flex-1 py-2.5 text-[10px] font-bold uppercase tracking-wider transition-colors ${activeTab === 'settings' ? 'text-church-700 border-b-2 border-church-500 bg-church-50/30' : 'text-stone-400 border-b-2 border-transparent hover:text-stone-600 hover:bg-stone-100/50'}`}>Settings</button>
          </div>

          <div className="flex-1 overflow-y-auto p-3 flex flex-col relative">
            {activeTab === 'details' ? (
              <div className="space-y-4">
                ...
                <div className="pt-3 mt-4 border-t border-stone-100 space-y-2 pb-2">
              ...
              <div className="flex-1 flex flex-col h-full space-y-4">
                 ...
                 <div className="mt-auto pt-6 mb-2 text-center">
                    <a href="https://github.com/brftherese/Liturgy-Builder" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-stone-400 hover:text-stone-600 transition-colors text-[10px] font-medium uppercase tracking-wider">
                        <Github size={12} />
                        View Source Code
                    </a>
                 </div>
